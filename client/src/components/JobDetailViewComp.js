...
const JobDetailView = ({job}) => {
    ...
    return(
        <Fragment>
            <button id={`btn${job.id}`} className="primary_blue dlevel1" onClick={openmod1}>View</button>
            <div className="modal_container" id={`id${job.id}`}>
                <div className="modal_content zi3" style={{height: "100vh", marginTop: "0px", width: "100vw"}}> 
                    ...
                    <div className="large6 medium8 small12 center">
                        ...
                        <button style={{margin: "0"}} className="secondary_blue small" onClick={queueApplied}>Apply</button>
            ...
            <div className="dialogue_box" id={`did${job.id}`}>
                <div className="dialogue_pane large12" style={{height: "46px", backgroundColor: "#0065AFCC"}}>
                    <span style={{fontSize: "24px", position: "relative", top: "6px", left: "10px"}}>Applied</span>
